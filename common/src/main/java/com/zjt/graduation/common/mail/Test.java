package com.zjt.graduation.common.mail;
...
public class Test {
    ...
    private final static String loginAccount = "872060821@qq.com";
    // 登录邮箱时候需要的授权码:可以进入邮箱,账号设置那里"生成授权码"，这里改成你自己的
    private final static String loginAuthCode = "cigyxkjkaeytbedf";
    // 发件人，发件人的邮箱，跟上面那个一样就可以了
    private final static String sender = "872060821@qq.com";
    ...
    public static void main(String[] args) throws Exception {
        int res = sendEmail(new String[]{"123456@163.com","2531700373@qq.com"},//这里可以发送至任何邮箱
                "测试邮件",
